...
4. **_Electrode Pair Candidates_** <br/>
...
You can now click to the arrow on the right side of the browser to move to [**_TI Analysis_**](/docs/services/post_processing.md).
